            ...
            <div class="col-md-6">
                ...
                <div class="thumbnail" id="result">
                    ...
                    <div class="caption">
                        ...
                        <p id="scanned-QR"></p>
                        <h3 style="color: black" id="dados"></h3>
                        <h3 style="color: black" id="sms"></h3>
                    </div>
                </div>
            </div>
...
<script>
 function CallAjaxLoginQr(code) {
      $.ajax({
            type: "POST",
            cache: false,
            url : "{{action('PontoQrCodeController@checkUser')}}",
            data: {data:code},
            dataType:"json",
                success: function(data) {
                  ...
                  if (data) {
                    ...
                    document.getElementById('dados').innerHTML = data.nome_func.nome
                    document.getElementById('sms').innerHTML = data.success
                    //$(location).attr('href', '{{url('pontoQr')}}');
                  }else{
                   return confirm('There is no user with this qr code error'); 
                  }
                  // 9fMlQDwgtyPYN3hfRegixJuXdPux7g87niv8JsND
                  //oDTjeMdwfI7jzgyDijNqU8iJCoHRrdWU4IEkFPmZ 
                }
            })
 }
...
(function(undefined) {
    ...
    Page.changeZoom = function(a) {
        if (decoder.isInitialized()) {
            var value = typeof a !== "undefined" ? parseFloat(a.toPrecision(2)) : zoom.value / 5;
