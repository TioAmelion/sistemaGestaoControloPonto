        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading "><a href="#addEmployeeModal" data-toggle="modal" class="btn btn-primary nav-link active" role="button">Add Férias</a>
                    ...
                    <a href="#Feriados" data-toggle="modal" class="btn btn-primary nav-link active" role="button">Ver mapa de Férias</a>
...
<div class="col-xs-10 col-xs-offset-1" >
  <div class="card col-xs-6" style="right: -360px">
    {!! $calendar->calendar() !!}
    {!! $calendar->script() !!}
  </div>
</div>
    ...
    <div class="modal-content">
      <form role="form" action="{{route('add_events')}}" method="POST">
        ...
        <div class="modal-header">                      
            <h4 class="modal-title">Add Ferias</h4>
